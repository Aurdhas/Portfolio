      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", background: "#0F0F0F", padding: "6rem 1.5rem 3rem" }}>
        ...
        <div className="hero-inner" style={{ maxWidth: "1100px", width: "100%", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "space-between", gap: "3rem" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: "clamp(0.9rem, 2vw, 1.3rem)", color: "rgba(255,255,255,0.6)", marginBottom: "1.5rem", minHeight: "2rem" }}>
            ...
            <p style={{ fontSize: "clamp(0.85rem, 1.5vw, 1rem)", color: "rgba(255,255,255,0.5)", maxWidth: "500px", lineHeight: 1.8, marginBottom: "2rem" }}>
              {portfolioData.personal.bio}
            </p>

            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              <a href="#projects" style={{ background: "linear-gradient(135deg, #7C3AED, #06B6D4)", color: "white", padding: "0.85rem 1.75rem", borderRadius: "50px", textDecoration: "none", fontWeight: 600, fontSize: "0.9rem", display: "inline-block" }}>
                Voir mes projets
              </a>
              <a href={portfolioData.personal.linkedin} target="_blank" rel="noopener noreferrer" style={{ background: "transparent", color: "white", padding: "0.85rem 1.75rem", borderRadius: "50px", textDecoration: "none", fontWeight: 600, fontSize: "0.9rem", border: "1px solid rgba(255,255,255,0.2)", display: "inline-block" }}>
                LinkedIn
              </a>
            </div>
          </div>
          ...
          <div className="hero-photo" style={{ position: "relative", flexShrink: 0 }}>
            ...
            <div style={{ position: "absolute", bottom: "10px", right: "-10px", background: "rgba(15,15,15,0.9)", border: "1px solid rgba(124,58,237,0.4)", borderRadius: "12px", padding: "8px 14px", zIndex: 2 }}>
              ...
              <div style={{ color: "#fff", fontSize: "0.75rem", fontWeight: 600 }}>Full-stack & Data</div>
            </div>
          </div>
        </div>
      </section>
